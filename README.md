# Enhanced Power App Webpart Multi-Parameter Variant

## Changes from Original Webpart and Motivation

This webpart is based on the original [Enhanced Power Apps Sample Webpart](https://github.com/pnp/sp-dev-fx-webparts/tree/6cbd8f819a811253907adc0d23dea2de3fed5e7c/samples/react-enhanced-powerapps/src/webparts/enhancedPowerApps) by Hugo Bernier & collaborators. 

I have modified this webpart to allow passing multiple parameters to the Power App, not just one as in the original version as Power Apps supports this. The 

Please note that this Version is not in any way part of the PnP programme and I have no affiliation with Microsoft. I am an independent consultant looking to solve his own problem and who knows, maybe also the same problem for others :)
