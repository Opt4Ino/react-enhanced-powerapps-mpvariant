define([], function() {
  return {
    ...
    DynamicPropsNameFieldLabel: "First parameter name",
    DynamicPropsNameFieldLabel2: "Second parameter name",
    DynamicPropFieldLabel: "Dynamic property source",
    SecondDynamicPropFieldLabel: "Second dynamic property source",
    ...
    PlaceholderIconText: "Enhanced Microsoft Power Apps (MP Variant)",
